...
public class SupportEnterAdapter extends BaseQuickAdapter<SupportOrderBean.DataBean, BaseViewHolder> {
    ...
    public SupportEnterAdapter(int layoutResId, @Nullable List<SupportOrderBean.DataBean> data) {
