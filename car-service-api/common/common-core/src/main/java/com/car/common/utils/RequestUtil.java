...
public class RequestUtil {
     ...
     */
    public static final String getIpAddressess(HttpServletRequest request) {
    ...
    private static String remoteAddr(HttpServletRequest request, String ip) {
        if (ip == null || ip.length() == 0 || UNKNOWN.equalsIgnoreCase(ip)) {
            ...
            if (log.isInfoEnabled()) {
                log.info("getIpAddressess(HttpServletRequest)-getRemoteAddr-String ip={}", ip);
            }
        }
        return ip;
    }
    ...
    private static String httpXforwardedFor(HttpServletRequest request, String ip) {
        if (ip == null || ip.length() == 0 || UNKNOWN.equalsIgnoreCase(ip)) {
            ...
            if (log.isInfoEnabled()) {
                log.info("getIpAddressess(HttpServletRequest)-HTTP_X_FORWARDED_FOR-String ip={}", ip);
            }
        }
        return ip;
    }
    ...
    private static String httpClientIp(HttpServletRequest request, String ip) {
        if (ip == null || ip.length() == 0 || UNKNOWN.equalsIgnoreCase(ip)) {
            ...
            if (log.isInfoEnabled()) {
                log.info("getIpAddressess(HttpServletRequest)-HTTP_CLIENT_IP-String ip={}", ip);
            }
        }
        return ip;
    }
    ...
    private static String wlProxyClientIp(HttpServletRequest request, String ip) {
        if (ip == null || ip.length() == 0 || UNKNOWN.equalsIgnoreCase(ip)) {
            ...
            if (log.isInfoEnabled()) {
                log.info("getIpAddressess(HttpServletRequest)-WL-Proxy-Client-IP-String ip={}", ip);
            }
        }
        return ip;
    }
    ...
    private static String proxyClientIp(HttpServletRequest request, String ip) {
        if (ip == null || ip.length() == 0 || UNKNOWN.equalsIgnoreCase(ip)) {
            ...
            if (log.isInfoEnabled()) {
                log.info("getIpAddressess(HttpServletRequest)-Proxy-Client-IP-String ip={}", ip);
            }
        }
        return ip;
    }
