...
docker run -d -v /etc/localtime:/etc/localtime:ro -v /var/local/java-log/utility:/var/local/java-log/utility --memory 800m --restart=always --name car-utility-dev --network host car-utility-dev
exit
remotessh
