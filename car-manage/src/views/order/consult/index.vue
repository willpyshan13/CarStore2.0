<template>
    <div class="app-container">
        <div class="filter-search">
            <el-form :inline="true">
                <el-form-item label="">
                    <el-input clearable v-model="filter.carOwnerName" placeholder="请输入咨询者姓名"></el-input>
                </el-form-item>
                <el-form-item label="">
                    <el-input clearable v-model="filter.carOwnerMobile" placeholder="请输入咨询者手机"></el-input>
                </el-form-item>
                <el-form-item label="">
                    <el-date-picker
                        clearable
                ...
                <el-form-item label="">
                    <el-select clearable v-model="filter.answerSts" placeholder="请选择答复反馈">
                        <el-option v-for="(item,index) in answerSts" :key="item.uuid" :label="item.lableDesc" :value="item.uuid"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
        ...
        <div class="table-list">
            <el-table
                ...
                <el-table-column
                    ...
                    label="订单类型"
                    min-width="120"
                    :formatter="(row) => {return formatterVal(row,'orderType')}"
                >
                </el-table-column>
                ...
                <el-table-column
                    prop="answerSts"
                    label="答复反馈"
                    :formatter="(row) => {return formatterVal(row,'answerSts')}"
                >
                </el-table-column>
                <el-table-column
                    label="操作"
...
import { queryOrderConsultList,exportOrderConsultList } from "@/api/order";
export default {
    name: 'ConsultOrder',
    data() {
        return {
    ...
    methods: {
        ...
        handleExport(){
            exportOrderConsultList(this.filter).then((res) => {
                const fileName = '问答订单信息.xls';
