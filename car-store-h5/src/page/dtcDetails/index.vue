<template>
  <div class="dtcDetail">
    ...
    <div class="cont">
      <div class="edit">
        <van-button v-if="zhanshi" plain type="info" size="small"
          >点击编辑</van-button
        >
      </div>
      <ul>
...
export default {
  ...
  activated() {
    ...
    this.orderOid = localStorage.getItem("dtcUuid");
    this.getDetail();
  },
  methods: {
    // dtc类型相关
    ...
    getDetail() {
      ...
      //   let par = "3319e61c2cbb4885ae58cd0fb0f4046d";
      orderApi.dtcDetail(par).then((res) => {
        if (res.code == "0000") {
          ...
          this.dtcExplain = resData.dtcExplain;
          this.dtcReasons = resData.dtcReasons;
          this.dtcDiagnose = resData.dtcDiagnose;
