...
- (void)setting{
    ...
    self.titleSegment.layer.borderColor = [UIColor whiteColor].CGColor;
...
//    [self.titleSegment setTitleTextAttributes:dicNormal forState:UIControlStateNormal];
    //未选中的图片
    [self.titleSegment setBackgroundImage:[UIImage imageWithColor:[UIColor whiteColor]] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
...
//    [self.titleSegment setTitleTextAttributes:dicSelect forState:UIControlStateSelected];
    ...
    [self.titleSegment setBackgroundImage:[UIImage imageWithColor:[UIColor whiteColor]] forState:UIControlStateSelected barMetrics:UIBarMetricsDefault];

    //去掉分割线
    [self.titleSegment setDividerImage:[UIImage imageWithColor:[UIColor whiteColor]] forLeftSegmentState:UIControlStateNormal rightSegmentState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
