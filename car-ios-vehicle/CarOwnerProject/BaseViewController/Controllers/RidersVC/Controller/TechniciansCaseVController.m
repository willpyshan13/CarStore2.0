...
{
    if (!_listTable) {
        _listTable =[[UITableView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, self.view.frame.size.height-NavigationBar_Height-BottomTab_Height-SafeAreaBottom_Height) style:UITableViewStyleGrouped];
