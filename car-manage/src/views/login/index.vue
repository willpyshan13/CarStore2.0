        ...
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
            ...
            <el-form-item prop="verificationCode">
                ...
                <div class="verify-pic">
                    <img @click.prevent.stop="_refreshPic" :src="verifyPic" alt="">
                </div>
            </el-form-item>
...
export default {
    ...
    methods: {
        _refreshPic(){
            this.verifyPic = process.env.VUE_APP_BASE_API + "/manager/oauth/queryVerificationCode?etc=" + new Date().getTime();
        },
        showPwd() {
