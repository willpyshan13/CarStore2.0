...
public class WXPay {
    ...
    private WechatPayConstants.SignType signType;
    ...
    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        ...
        if (useSandbox) {
            this.signType = WechatPayConstants.SignType.MD5; // 沙箱环境
        }
        else {
            this.signType = WechatPayConstants.SignType.HMACSHA256;
        }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        if (WechatPayConstants.SignType.MD5.equals(this.signType)) {
            reqData.put("sign_type", WXPayConstants.MD5);
        }
        else if (WechatPayConstants.SignType.HMACSHA256.equals(this.signType)) {
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        WechatPayConstants.SignType signType;
        if (signTypeInData == null) {
            signType = WechatPayConstants.SignType.MD5;
        }
        else {
            ...
            if (signTypeInData.length() == 0) {
                ...
                signType = WechatPayConstants.SignType.HMACSHA256;
            }
            else {
