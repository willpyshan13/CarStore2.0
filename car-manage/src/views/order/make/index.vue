...
<!--                </el-form-item>-->
                <el-form-item label="">
                    <el-select clearable v-model="filter.orderStatus" placeholder="请选择订单状态">
                        <el-option v-for="(item,index) in makeOrderSts" :key="item.uuid" :label="item.lableDesc" :value="item.uuid"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
        ...
        <div class="table-list">
            <el-table
                ...
                <el-table-column
                    prop="orderStatus"
                    label="订单状态"
                    :formatter="(row) => {return formatterVal(row,'orderStatus')}"
                >
                </el-table-column>
                <el-table-column
                    label="操作"
...
import { makeOrderList } from "@/api/order";
export default {
    name: 'MakeOrder',
    data() {
        return {
