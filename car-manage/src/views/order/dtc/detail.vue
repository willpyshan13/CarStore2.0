                                ...
                                <el-row>
                                    <el-col :span="8">
                                        <el-form-item label="故障代码">
                                            <div class="exhibition-text">{{ form.dtcCode }}</div>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="8">
                                        <el-form-item label="故障名称">
                                            <div class="exhibition-text">{{ form.dtcDefinition }}</div>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                            </el-col>
...
import { dtcOrderDetail } from "@/api/order";
export default {
    name: 'DtcOrderDetail',
    data() {
        return {
    ...
    methods: {
        initData() {
            this.loading = true;
            dtcOrderDetail(this.uuid).then((res) => {
                let { data } = res;
                this.form = data;
                this.loading = false;
            }).catch((e) => {
