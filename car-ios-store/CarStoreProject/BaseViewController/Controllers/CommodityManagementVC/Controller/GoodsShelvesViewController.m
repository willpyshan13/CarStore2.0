...
@interface GoodsShelvesViewController ()<UITableViewDelegate,UITableViewDataSource>
...
static NSString * const OnGoodsManagementTableViewCellIdentify = @"GoodsManagementTableViewCell";//上架商品
...
-(void)requestqueryStoreGoodsListWithPage:(NSInteger)page
{
    ...
    [HTTPManager postRequestWithUrl:urlStr parameters:pageBoDict header:headerDict progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        DLog(@"上架商品responseObject===%@",responseObject);
...
{
    GoodsManagementTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:OnGoodsManagementTableViewCellIdentify forIndexPath:indexPath];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.stateLab.text = @"已上架";
...
-(UITableView *)listTable
{
    if (!_listTable) {
        ...
        [_listTable registerNib:[UINib nibWithNibName:@"GoodsManagementTableViewCell" bundle:nil] forCellReuseIdentifier:OnGoodsManagementTableViewCellIdentify];
