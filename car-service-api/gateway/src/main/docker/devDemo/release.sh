...
docker rmi car-gateway-dev-demo
docker build -t car-gateway-dev-demo -f ../src/main/docker/devDemo/Dockerfile .

ssh root@58.33.180.67 << remotessh
rm -rf /var/local/docker-images-tar/car-gateway-dev-demo.tar
docker save car-gateway-dev-demo -o /var/local/docker-images-tar/car-gateway-dev-demo.tar
scp /var/local/docker-images-tar/car-gateway-dev-demo.tar root@8.136.105.20:/var/local/docker-images-tar/car-gateway-dev-demo.tar
exit
remotessh
ssh root@8.136.105.20 << remotessh
docker stop car-gateway-dev-demo
docker rm car-gateway-dev-demo
docker rmi car-gateway-dev-demo
docker load < /var/local/docker-images-tar/car-gateway-dev-demo.tar
docker run -d -v /etc/localtime:/etc/localtime:ro -v /var/local/java-log/gatewayDemo:/var/local/java-log/gateway --memory 1000m --restart=always --name car-gateway-dev-demo --network host car-gateway-dev-demo
exit
remotessh
