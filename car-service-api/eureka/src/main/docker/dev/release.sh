...
docker run -d -v /etc/localtime:/etc/localtime:ro -v /var/local/java-log/eureka:/var/local/java-log/eureka --memory 600m --restart=always --name car-eureka-dev --network host car-eureka-dev
exit
remotessh
