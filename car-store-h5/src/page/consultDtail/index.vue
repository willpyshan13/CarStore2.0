			...
			<div class="content">
				...
				<div class="question-detail">
					<div class="section">
						...
						<div class="pic-list" v-if="
                orderDetail.consultImgUrlList &&
                  orderDetail.consultImgUrlList.length
              ">
							<div class="item" v-for="(item, index) in orderDetail.consultImgUrlList" :key="index">
								<!--<van-image width="100%" height="2.8rem" fit="cover" :src="item" />-->
					...
					<div class="section" style="margin-top:0.4rem;" v-if="orderDetail.orderSts == 1">
						<div class="title">
							{{ orderDetail.technicianName && orderDetail.technicianName.substring(0, 1) }}师傅的回答
						</div>
						<div class="desc">
              ...
              ">
							<div class="item" v-for="(item, index) in orderDetail.answerUrlList" :key="index">
								<van-image width="100%" height="2.8rem" fit="cover" :src="item" />
							</div>
						</div>
					</div>
...
//				let canshu = this.uuid;
				orderApi.myQuestsDetail(canshu).then((res) => {
